define ["underscore", "backbone", "jquery", "bootstrap", "template", "form", "prettify", "wysiwyg", "hotkeys", "abstract-view"], (_, Backbone, $, bootstrap, temp, form, prettify, wysiwyg, hotkeys, AbstractView) ->
      ...
      options =
        beforeSubmit: (arr, $form, options) ->
          for i of arr
            ...
            arr[i].value = escape($editor.html())  if arr[i].name is "description"
