...
from changebyus.modules.user.helpers import ( _get_user_by_email, _verify_user_password )
from changebyus.modules.project.api import api_get_projects
from changebyus.helpers.flasktools import ReturnStructure, jsonify_response, as_multidict
