// Select adapted from Bootstrap-Select by Silvio Moreto

!function($) {
    var SelectWide = function(element, options, e) {
        if (e ) {
            e.stopPropagation();
            e.preventDefault();
        }
        ...
        this.button = null;
        this.options = $.extend({}, $.fn.SelectWide.defaults, this.$element.data(), typeof options == 'object' && options);
        this.style = this.options.style;
        this.size = this.options.size;
        this.init();
    };

    SelectWide.prototype = {

        constructor: SelectWide,
        ...
        getTemplate: function() {
            var template =
                "<div class='btn-group bootstrap-select wide'>" +
                    "<button class='btn no-fill dropdown-toggle clearfix' data-toggle='dropdown'>" +
    ...
    $.fn.SelectWide = function(option, event) {
        return this.each(function () {
            var $this = $(this),
                data = $this.data('SelectWide'),
                options = typeof option == 'object' && option;
            if (!data) {
                $this.data('SelectWide', (data = new SelectWide(this, options, event)));
            }
